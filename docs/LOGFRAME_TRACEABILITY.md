...
|---|---|---|---|---|
| A.1.1.1 System Architecture Refinement | ≥90% priority backend tests pass | Automated unit, integration, retrieval, MCP, and application smoke tests | `tests/`, CI results, release record | GitHub CI and local gates pass 36/36 tests, including identity, ownership, artifacts, retention, trusted-source, prompt, and WhatsApp webhook controls; priority-set approval remains pending |
